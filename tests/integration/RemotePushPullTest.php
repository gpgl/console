...
use gpgl\console\Commands\Remote\{Push,Pull};
use gpgl\console\Commands\{Set,Get};
use gpgl\console\Container;

class RemotePushPullTest extends TestCase
{
    ...
    public function test_pushes_new_value()
    {
        $app = new Application;
        $app->add(new Set);
    ...
    public function test_pulls_new_value()
    {
        $app = new Application;
        $app->add(new Get);
